...
- [x] Klickbar ägare/profilsida för skapade offentliga recept: deployat 2026-07-08. När ett kort visar "från Julia" kan man klicka på Julia och se alla offentliga recept skapade av den användaren. Bygger på `recipes_index WHERE owner_id = ?`, inte på sparade recept. Form: `GET /users/:id/recipes` + `#/anvandare/:ownerId`, samma kort/gruppering som Allas recept. Kvar: inloggat prodtest av själva klickflödet.
