...
- `starter.json`: 17 startrecept, konverterade till g/ml (1 msk=15 ml, 1 tsk=5 ml, 1 dl=100 ml + vikttabeller). 11 av dem importerade från `recept 2.mht` eller enskilda källor 2026-07-07; några saknar nedskrivna steg (källan var bara video/länk) och visas som "Inga steg nedskrivna".
