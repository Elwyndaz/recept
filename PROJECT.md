...
## Funktion (as built)
- Receptbibliotek och inköpslista är UNIKA per användare. `starter.json` (17 recept) är bara fröet: kopieras till localStorage vid första besöket och laddas upp till kontot vid registrering. Recept läggs till/redigeras/tas bort i UI:t, INTE via repot.
